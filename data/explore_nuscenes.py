...
if __name__ == "__main__":
    ...
    for split in splits:
        ...
        for scene_name in split_scenes:
            ...
            for data in scene_data_orig:  # add additional frames from previous timesteps into the scene
            ...
            all_instances = np.unique(all_tokens[:, 0]).tolist()  # singel object at a single timestep
            first_sample_token = scene['first_sample_token']
            first_sample = nuscenes.get('sample', first_sample_token)  # singel timestep; many objects.
            ...
            while True:
                if sample['token'] in all_samples:
                    ...
                    for ann_token in sample['anns']:
                        ...
                        # if this annotation is present in the orginial scene, 1.
                        # else, the annotation was added as an additional annotation, and thus we should not predict it??
