...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_out', default='datasets/nuscenes_trac/', help="path where you save the processed data")
    ...
    for split in splits:
        ...
        for scene_name in split_scenes:
            ...
            cv2.imwrite(f'{DATAOUT}/map_{map_version}/vis_{scene_name}.png',
                        cv2.cvtColor(np.transpose(map_mask_plot, (1, 2, 0)), cv2.COLOR_RGB2BGR))
