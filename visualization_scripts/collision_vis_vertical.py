...
from viz_utils_img import plot_scene, plot_img_grid, plot_img_grid_new
    ...
    for frame_path_ in all_frames:
        ...
        for method_i, method in enumerate(args.method):
            ...
            if method != OURS:
                ...
                plot_args = [anim_save_fn, "", bounds, grid, METHODS_ON_TOP, 6.5, [*non_ours_args_list, args_list]]
