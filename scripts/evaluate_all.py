""" evaluate using eval_one_seq already-saved trajectories. analogous to the function in trajectory_reward.
unsure if this file actually works, tho."""
...
def peds_pandas_way(data, labels, indices, verbose=False):
    ...
    # todo
    # print(df)
    # df = df.sort_values(by=indices[::-1])
